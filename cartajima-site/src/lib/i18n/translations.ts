...
const translations = {
	en: {
		...
		documents: {
			...
			close: 'Close',
			proyectoActuacion: 'Main Project',
			proyectoActuacionDesc: 'Action Project for Ecotourism Development',
			anexoI: 'Annex I - Environmental Authorization',
			anexoIDesc: 'Simplified Environmental Authorization',
			anexoII: 'Annex II - Plans',
			anexoIIDesc: 'Technical plans and blueprints',
			anexoIII: 'Annex III - Economic Viability',
			anexoIIIDesc: 'Economic viability study',
			planosAdicionales: 'Additional Plans',
			planosAdicionalesDesc: 'Supplementary technical drawings'
		},
		ownerPage: {
			title: 'My Vision',
			back: '← Back',
			opening: '40 minutes from Marbella heading towards Ronda, we find Cartajima as the highest entrance to the Genal Valley. Only 15 minutes from Ronda, this valley presents unique landscape characteristics due to its chestnut forests.',
			highlight: 'The estate has 78,000 m² and has a special protection status, as it is located in this valley of such singular landscape. That is why this license for the action project is so valuable.',
			personal: 'I have had to wait more than 20 years since I bought the estate to achieve a political alignment between the Town Hall, the Junta de Andalucía (Regional Government), and the Diputación de Málaga (Provincial Council), which made this license possible. Unfortunately, it is now too late for me. Over all these years, my family and personal circumstances have changed, and I am no longer in a position to develop my vision.',
			projectTitle: 'The Project',
			projectDesc1: 'It is an ecotourism complex composed of 10 small houses, a large central building, storage, orchard... The idea is that due to the size of the estate, you can build the 10 houses far enough apart so that each tenant has a complete sense of intimacy and connection with nature.',
			projectEmphasis: 'For me, this is the great luxury of the future.',
			projectDesc2: 'In the large central house, events, courses, meetings... can be held, so that tenants have a space where they can connect with other people.',
			projectDesc3: 'The estate has everything needed to build one of the most special places in Málaga.',
			feature1: 'Water supply from the village, as well as a spring that I have not seen dry up even in the driest years. On the southern boundary, the Arrollo Blanco (White Stream) has waterfalls and pools where you can refresh yourself. On a walk, you reach the Genal River and its crystal-clear water pools.',
			feature2: 'An electricity pole on the estate itself from which electrical supply can be connected for the entire complex.',
			feature3: 'South-facing orientation and a moderate slope.',
			feature4: 'The entire project is located on 2 of the 4 plots of the estate, leaving two other plots available for other uses.',
			feature5: 'Its location 40 minutes from Marbella and 15 from Ronda, the two most tourist points in Málaga.',
			feature5Note: '(It is expected that in the coming years the Ronda-Marbella road will be widened, which would notably reduce this time)'
		},
		visionPage: {
			title: 'Project',
			layout: 'The Layout',
	...
	es: {
		...
		documents: {
			...
			close: 'Cerrar',
			proyectoActuacion: 'Proyecto Principal',
			proyectoActuacionDesc: 'Proyecto de Actuación para Ecoturismo',
			anexoI: 'Anexo I - Autorización Ambiental',
			anexoIDesc: 'Autorización Ambiental Simplificada',
			anexoII: 'Anexo II - Planos',
			anexoIIDesc: 'Planos técnicos y dibujos',
			anexoIII: 'Anexo III - Viabilidad Económica',
			anexoIIIDesc: 'Estudio de viabilidad económica',
			planosAdicionales: 'Planos Adicionales',
			planosAdicionalesDesc: 'Dibujos técnicos complementarios'
		},
		ownerPage: {
			title: 'Mi Visión',
			back: '← Volver',
			opening: 'A 40 minutos de Marbella direccional Ronda encontramos Cartajima como entrada más alta al Valle del Genal. A solo 15 minutos de Ronda este valle presenta unas características paisajísticas únicas por sus bosques de castaño.',
			highlight: 'La finca tiene 78.000 m² y cuenta con una figura de protección especial, por estar en este Valle de paisaje tan singular. Por eso esta licencia para proyecto de actuación es tan valiosa.',
			personal: 'He tenido que esperar más de 20 años desde que compré la finca para conseguir una alineación política de Ayuntamiento, Junta de Andalucía y Diputación de Málaga, que hiciesen posible esta licencia. Desgraciadamente ya es demasiado tarde para mí. En todos estos años mis circunstancias familiares y personales han cambiado y ya no estoy en situación de desarrollar mi visión.',
			projectTitle: 'El Proyecto',
			projectDesc1: 'Es un complejo de ecoturismo compuesto por 10 casitas, una gran estancia central, almacén, huerta… La idea es que por el tamaño de la finca puedes construir las 10 casitas lo bastante separadas entre sí para que cada inquilino tenga total sensación de intimidad y conexión con la naturaleza.',
			projectEmphasis: 'Para mí, esto es el gran lujo del futuro.',
			projectDesc2: 'En la casa grande central se pueden celebrar eventos, cursos, reuniones... de manera que los inquilinos tengan un espacio donde poder conectar con otras personas.',
			projectDesc3: 'La finca tiene todo lo necesario para construir en ella uno de los lugares más especiales de Málaga.',
			feature1: 'Suministro de agua del pueblo, así como un manantial que no he visto secarse ni en los años más secos. En la linde sur el Arrollo Blanco tiene cascadas y pozas donde poder refrescarse. En un paseo llegas al Río Genal y sus pozas de agua cristalina.',
			feature2: 'Un poste de luz en la propia finca del que puede conectarse suministro eléctrico para todo el complejo.',
			feature3: 'Orientación Sur y una pendiente moderada.',
			feature4: 'Todo el proyecto se emplaza en 2 de las 4 parcelas de la finca, por lo que quedan otras dos parcelas disponibles para otros usos.',
			feature5: 'Su situación a 40 minutos de Marbella y 15 de Ronda, los dos puntos más turísticos de Málaga.',
			feature5Note: '(Se espera que en los próximos años se amplíe la carretera Ronda-Marbella, lo que disminuiría este tiempo notablemente)'
		},
		visionPage: {
			title: 'Proyecto',
